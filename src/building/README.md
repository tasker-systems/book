...
**[Quick Start](quick-start.md)** — Two ways to get running fast:
...
1. **[Installation](install.md)** — Install language packages and run Tasker infrastructure
2. **[Using tasker-ctl](tasker-ctl.md)** — Initialize projects, generate handlers from templates, manage configuration
3. **[Your First Handler](first-handler.md)** — Write a step handler in your preferred language
4. **[Your First Workflow](first-workflow.md)** — Define a task template, submit a task, watch it execute
...
After building your first project, see **[Next Steps](next-steps.md)** for where to go from here — example apps, engineering stories, architecture deep-dives, and production operations.
